document.querySelectorAll(".slider_product").forEach(wrapper => {
  let carousel = wrapper.querySelector(".list_product");
  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      carousel.scrollLeft += btn.className == "btn_slider_product fas fa-angle-left" ? -cardWidth : cardWidth;
    });
  });
