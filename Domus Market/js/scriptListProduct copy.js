...
// var container = document.getElementById('slider_product')
...
const wrapper = document.querySelector(".slider_product");
const carousel = document.querySelector(".list_product");
